...
func Benchmark_TLS_HTTP_HMAC(b *testing.B) {
	...
	u := &thttp.DiagRecorderData{CanId: payload.GetCanID(), Payload: &thttp.Payload{Body: body}}
	b.ResetTimer()
	...
	b.RunParallel(func(pb *testing.PB) {
		for pb.Next() {
			doTLSHmacPost(client, u, b)
		}
	})
}

func doTLSHmacPost(hclient *http.Client, data interface{}, b *testing.B) {
